...
#define EEPROM_SIZE_BYTES    0x9000           // Reserve 36k of flash memory (ensure this value is divisible by 256)
#define EEPROM_ADDRESS_START _u(0x101F7000) // The arduino-pico EEPROM lib starts here, so we'll do the same
