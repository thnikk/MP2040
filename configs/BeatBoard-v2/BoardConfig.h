...
#define BOARD_CONFIG_LABEL "BeatBoard-v2"
...
#define KEYCODE_GP02 HID_KEY_F13
#define KEYCODE_GP01 HID_KEY_F14
#define KEYCODE_GP07 HID_KEY_F15
#define KEYCODE_GP00 HID_KEY_F16

// Gamepad default mapping (used in gamepad input modes)
#define GAMEPAD_GP02 GAMEPAD_PIN_MASK_B1   // button 1 -> B1
#define GAMEPAD_GP01 GAMEPAD_PIN_MASK_B2   // button 2 -> B2
#define GAMEPAD_GP07 GAMEPAD_PIN_MASK_B3   // button 3 -> B3
#define GAMEPAD_GP00 GAMEPAD_PIN_MASK_B4   // button 4 -> B4
...
#define TOUCH_GP02 1
#define TOUCH_GP07 1
#define TOUCH_GP26 1  // Touch ring
#define TOUCH_GP27 1
#define TOUCH_GP28 1
#define TOUCH_GP29 1
