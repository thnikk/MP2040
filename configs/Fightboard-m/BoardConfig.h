...
#define GAMEPAD_GP27 GAMEPAD_PIN_MASK_L1
#define GAMEPAD_GP26 GAMEPAD_PIN_MASK_R1
#define GAMEPAD_GP09 GAMEPAD_PIN_MASK_B1
#define GAMEPAD_GP12 GAMEPAD_PIN_MASK_B2
#define GAMEPAD_GP13 GAMEPAD_PIN_MASK_L2
#define GAMEPAD_GP14 GAMEPAD_PIN_MASK_R2
...
#define LED_COLOR_NORMAL_GP27 0x8800FF // L1 purple
#define LED_COLOR_NORMAL_GP13 0x00FFFF // L2 aqua
#define LED_COLOR_NORMAL_GP26 0xFF8800 // R1 orange
#define LED_COLOR_NORMAL_GP14 0xFF0088 // R2 pink
...
#define BOARD_DISPLAY_LAYOUT \
    { \
    /* action buttons (mirrored left): R1(26) L1(27) B4(28) B3(15) / R2(14) L2(13) B2(12) B1(9) */ \
