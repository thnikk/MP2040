...
// step to the previous / next profile (pins 12=L3, 9=R3, 14=Left, 26=Right).
#define HOTKEY_01_KEYS   { 12, 9, 14 }
#define HOTKEY_01_ACTION HOTKEY_PREVIOUS_PROFILE
#define HOTKEY_02_KEYS   { 12, 9, 26 }
...
// Mini-menu toggle hotkey: B1(6) + R3(9) + L3(12) (the former menu combo).
...
#define BOARD_DISPLAY_LAYOUT \
    ...
    {GP_ELEMENT_PIN_BUTTON, {16, 19, 7, 7, 1, 1, 27, GP_SHAPE_ELLIPSE}}, \
    {GP_ELEMENT_PIN_BUTTON, {32, 23, 7, 7, 1, 1, 28, GP_SHAPE_ELLIPSE}}, \
    {GP_ELEMENT_PIN_BUTTON, {48, 27, 7, 7, 1, 1, 29, GP_SHAPE_ELLIPSE}}, \
    {GP_ELEMENT_PIN_BUTTON, {11, 35, 7, 7, 1, 1, 14, GP_SHAPE_ELLIPSE}}, \
    {GP_ELEMENT_PIN_BUTTON, {27, 39, 7, 7, 1, 1, 15, GP_SHAPE_ELLIPSE}}, \
    {GP_ELEMENT_PIN_BUTTON, {43, 43, 7, 7, 1, 1, 26, GP_SHAPE_ELLIPSE}}, \
    /* utility: L3(12) S1(13) A1(1) S2(8) R3(9) */ \
    {GP_ELEMENT_PIN_BUTTON, { 7, 47, 3, 3, 1, 1, 12, GP_SHAPE_ELLIPSE}}, \
    {GP_ELEMENT_PIN_BUTTON, {15, 47, 3, 3, 1, 1, 13, GP_SHAPE_ELLIPSE}}, \
    {GP_ELEMENT_PIN_BUTTON, {73, 16, 3, 3, 1, 1,  1, GP_SHAPE_ELLIPSE}}, \
    {GP_ELEMENT_PIN_BUTTON, {112, 47, 3, 3, 1, 1,  8, GP_SHAPE_ELLIPSE}}, \
    {GP_ELEMENT_PIN_BUTTON, {120, 47, 3, 3, 1, 1,  9, GP_SHAPE_ELLIPSE}}, \
    /* action buttons: R1(4) B4(3) R2(2)  B3(7) B1(6) B2(5) */ \
    {GP_ELEMENT_PIN_BUTTON, {111, 19, 7, 7, 1, 1,  4, GP_SHAPE_ELLIPSE}}, \
    {GP_ELEMENT_PIN_BUTTON, {95, 23, 7, 7, 1, 1,  3, GP_SHAPE_ELLIPSE}}, \
    {GP_ELEMENT_PIN_BUTTON, {79, 27, 7, 7, 1, 1,  2, GP_SHAPE_ELLIPSE}}, \
    {GP_ELEMENT_PIN_BUTTON, {116, 35, 7, 7, 1, 1,  7, GP_SHAPE_ELLIPSE}}, \
    {GP_ELEMENT_PIN_BUTTON, {100, 39, 7, 7, 1, 1,  6, GP_SHAPE_ELLIPSE}}, \
    {GP_ELEMENT_PIN_BUTTON, {84, 43, 7, 7, 1, 1,  5, GP_SHAPE_ELLIPSE}} \
    }
