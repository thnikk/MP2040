...
#define KEYCODE_GP27 HID_KEY_1
#define KEYCODE_GP28 HID_KEY_3
#define KEYCODE_GP29 HID_KEY_4
#define KEYCODE_GP06 HID_KEY_5
#define KEYCODE_GP07 HID_KEY_6
#define KEYCODE_GP00 HID_KEY_7
#define KEYCODE_GP01 HID_KEY_8
#define KEYCODE_GP02 HID_KEY_9
...
#define LED_INDEX_GP27 0
#define LED_INDEX_GP28 1
#define LED_INDEX_GP29 2
#define LED_INDEX_GP06 3
#define LED_INDEX_GP07 4
#define LED_INDEX_GP00 5
#define LED_INDEX_GP01 6
#define LED_INDEX_GP02 7
