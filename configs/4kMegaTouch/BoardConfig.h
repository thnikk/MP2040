...
// that.
#define KEYCODE_GP26 HID_KEY_D
#define KEYCODE_GP27 HID_KEY_F
#define KEYCODE_GP02 HID_KEY_ESCAPE
#define KEYCODE_GP04 HID_KEY_GRAVE
#define KEYCODE_GP00 HID_KEY_J
...
#define BOARD_LED_POSITION_COLS 5
