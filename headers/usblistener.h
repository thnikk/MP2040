...
// Implemented by anything that wants to observe devices plugged into the
// USB host port (e.g. PS4AuthUSBListener for an auth dongle). Registered
// with USBHostManager::pushListener().
class USBListener
{
public:
